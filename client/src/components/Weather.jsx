...
export default function Weather({ setCity, units, setUnits, weather }) {
  return (
    <div className={`border-2 border-slate-100 border-opacity-5 rounded-2xl ml-auto mr-2 max-w-screen-md mt-4 py-5 px-4 sm:px-6 lg:px-8 bg-gradient-to-br h-fit shadow-[0_3px_10px_rgb(0,0,0,0.5)] backdrop-blur-xl`}>
