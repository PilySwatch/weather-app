...
export default function Weather({ setCity, units, setUnits, weather }) {
  return (
    <div className={`border-2 border-slate-100 border-opacity-5 rounded-2xl max-w-screen-md w-full mt-2 mr-4 py-4 px-5 bg-gradient-to-br h-fit shadow-[0_3px_10px_rgb(0,0,0,0.5)] backdrop-blur-2xl`}>
